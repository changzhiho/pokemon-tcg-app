...
namespace PokemonTcgApp.Tests
{
    public class FavoritesServiceTests
    {
        ...
        public async Task GetFavoritesAsync_ReturnsEmptyList_WhenNoFavoritesExist()
        {
            ...
            _mockJsRuntime
                .Setup(js => js.InvokeAsync<string>(
                    ...
                    It.Is<object[]>(args => args.Length > 0 && args[0].ToString() == "pokemon_favorites")))
        ...
        public async Task AddFavoriteAsync_AddsFavorite_WhenCardIsNotAlreadyFavorite()
        {
            ...
            // Use InvokeAsync<object> instead of InvokeVoidAsync
            _mockJsRuntime
            ...
            _mockJsRuntime.Verify(js => 
                js.InvokeAsync<object>("localStorage.setItem", It.IsAny<object[]>()), 
                Times.Once);
        }
